...
def main():
    ...
    with st.sidebar:
        ...
        # Open AI API 키 입력받기
        st.session_state["OPENAI_API"] = st.text_input(label='OPENAI API 키', placeholder='Enter Your OpenAI API Key', value='sk-0wwBNUb-n5mvilGP36n423XGmhqLZiE6EtkNX36v5tT3BlbkFJG7zK0hsrKCUC77QUfF5MWK9Gkg9DeY3rZ9EuFte-gA',type='password')
